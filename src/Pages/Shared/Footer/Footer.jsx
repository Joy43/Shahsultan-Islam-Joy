  ...
  return (
    <div className="shadow-2xl m-4 ">
      {/* <footer className="footer p-10 bg-neutral text-neutral-content">
        ...
        <nav>
          <header className="footer-title text-xl">Contact with Me !</header>
      ...
      <footer className="footer footer-center p-10 bg-base-300 ">
        ...
        <aside>
          ...
          <p className="font-bold">
            shahsultan islam joy <br /> ssjoy43@gmail.com
          </p>
          <p>Mirpur Dhaka-2100 © 2024 - All right reserved</p>
        </aside>
        <nav>
          <div className="grid grid-flow-col gap-4">
            {/* ------------linked----------- */}
